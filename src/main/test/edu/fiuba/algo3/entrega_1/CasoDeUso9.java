...
public class CasoDeUso9 {
    ...
    public void unEdificioProtossSigueOperativoCuandoPorLoMenosUnPilonLoEnergiza()  {
        ...
        jugadorProtoss.construirEdificio(new Coordenada(8,5), new Pilon());
        ...
        //el zerling ataca el pilon hasta destruirlo y el acceso deberia seguir operativo
        for (int i = 0; i < 149; i++) {
        ...
        try {
            ...
            System.out.println("Se destruyo uno de los pilones");
        }

        //Se pude generar una unidad en el acceso luego de pasar el turno
        algoStar.pasarTurno();
        algoStar.pasarTurno();
        jugadorProtoss.generarUnidad(new Coordenada(8, 3), new Zealot());

        Assertions.assertThrows(UnidadNoTerminoDeConstruirse.class , () -> {
            jugadorProtoss.moverUnidad(new Coordenada(8,2), new Derecha());
        });
    }
