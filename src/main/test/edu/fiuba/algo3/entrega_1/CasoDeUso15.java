...
public class CasoDeUso16 {
    ...
    public void noSePuedeConstruirUnExtractorSobreOtroExtractor() {
        ...
        algoStar.generarUnidad(1,1);
        algoStar.moverDerecha(1,1);
        algoStar.seleccionarCasilla(1,1).ponerUnidadATrabajar();
        // Algostar.ponerUnidadATrabajar(int x, int y) = {
        // Trabajador unidadTrabajadora = (Trabajador)this.mapa.buscarCasilla(x,y).devolverUnidad();
        // Trabajable edificioTrabajable = (Trabajable)this.mapa.buscarCasilla(x,y).devolverEdificio();
